  ...
  const slides = [
    ...
    >
      <Text style={[styles.text, styles.text_lg]}>
        Welcome to MyGas Motorista Card
      </Text>
      <Text style={[styles.text, styles.text_sm]}>
        Gas Up and earn rewards and points.
      </Text>
    </View>,
    <View
      style={{
    ...
    >
      ...
      <Text style={[styles.text, styles.text_sm]}>
        Every fill-up brings you closer to exciting rewards and exclusive perks.
        Start earning today!
      </Text>
    </View>,
    <View
    ...
    >
      ...
      <Text style={[styles.text, styles.text_sm]}>
        Save more with our limited-time offers on fuel and rewards. Fill up and
        enjoy the benefits.
      </Text>
    </View>,
  ];
