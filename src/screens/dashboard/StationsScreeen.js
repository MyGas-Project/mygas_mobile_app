import { View, ImageBackground, Text, TouchableOpacity, FlatList, StyleSheet, Image, Linking } from 'react-native'
    ...
    return (
        <View style={styles.tabScreen}>
            ...
            <View style={{width: '100%', paddingTop: 16, paddingHorizontal: 16}}>
                <Text style={[styles.text, styles.text_md, styles.text_bold, styles.text_primary]}>Locate Stations</Text>
            </View>
            <View style={{flex: 1, width: '100%', padding: 20}}>
                ...
                <View style={{ flex: 1, paddingTop: 16 }}>
                    <Text style={[styles.text, styles.text_md, styles.text_bold, styles.text_primary]}>Nearby Gasoline Stations</Text>
                    <FlatList
                    data={stationsData}
                    ...
                    renderItem={({ item }) => (
                        ...
                        >
                          <View style={custom_styles.stationInfo}>
                            ...
                            <Text style={custom_styles.fuelTypes}>Fuel Types: {item.fuelTypes}</Text>
                            <Text style={custom_styles.stationDistance}>{item.distance}</Text>
                            <Text style={custom_styles.operatingHours}>Hours: {item.hours}</Text>
                            <Text style={custom_styles.amenities}>Amenities: {item.amenities}</Text>
                            ...
                            >
                              <Text style={custom_styles.directionsButtonText}>Get Directions</Text>
                            </TouchableOpacity>
                          </View>
